...
//        BufferBuilder var6 = var7.getWorldRenderer();
        ...
        buffer.pos(par1, par4, 0.0).endVertex();
        buffer.pos(par3, par4, 0.0).endVertex();
        buffer.pos(par3, par2, 0.0).endVertex();
        buffer.pos(par1, par2, 0.0).endVertex();
        var7.draw();
