...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.mc.fontRendererObj.drawStringWithShadow(String.format("%s* \u00a77Username", new Object[]{this.usernameBox.getText().length() > 1 ? ChatFormatting.GREEN : ChatFormatting.RED}), this.width / 2 - 109, 63.0f, 0xA0A0A0);
        this.mc.fontRendererObj.drawStringWithShadow("Password", this.width / 2 - 100, 103.0f, 0xA0A0A0);
        this.mc.fontRendererObj.drawStringWithShadow(this.errorMessage, this.width / 2 - this.fontRendererObj.getStringWidth(this.errorMessage), 13.0f, 0xA0A0A0);
