...
implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        this.buttonList.add(random = new GuiButton(6, this.width / 2 - 154, this.height - 26, 73, 20, "Random"));
...
//            }
    ...
    public void actionPerformed(GuiButton guiButton) {
        block21: {
            ...
            if (guiButton.id == 2 && random.enabled) {
                try {
...
//                    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.mc.fontRendererObj.drawStringWithShadow(Minecraft.getMinecraft().getSession().getUsername(), this.width - this.mc.fontRendererObj.getStringWidth(Minecraft.getMinecraft().getSession().getUsername()) - 2, 2.0f, 0xA0A0A0);
        this.mc.fontRendererObj.drawStringWithShadow("Accounts: " + Exeter.getInstance().getAccountManager().getRegistry().size(), 2.0f, 2.0f, 0xA0A0A0);
