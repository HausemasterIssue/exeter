package me.friendly.exeter.module.impl.render.tabgui.item;
    ...
    public void drawTabMenu(Minecraft mc, int x, int y) {
        ...
        for (int i = 0; i < this.mods.size(); ++i) {
            ...
            if (this.gui.getSelectedItem() == i) {
                ...
                //RenderMethods.drawBorderedRectReliant(x, (boxY + transitionTop) - 0.3f, (x + menuWidth) + 4.5f, (boxY + 12.0f + transitionBottom) + 0.3f, 1.0f, Colors.getClientColor(), -2013265920);
            }
