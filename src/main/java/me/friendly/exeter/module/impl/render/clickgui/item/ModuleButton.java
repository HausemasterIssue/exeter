...
import me.friendly.exeter.module.impl.render.clickgui.item.properties.BindButton;
...
extends Button {
    ...
    public ModuleButton(Module module) {
        ...
        Keybind bind = Exeter.getInstance().getKeybindManager().getKeybindByLabel(module.getLabel());
        if (bind != null) {
            if (!module.getLabel().equals("TabGui") && !module.getLabel().equals("Hud") && !module.getLabel().equals("Colors")) {
                items.add(new BindButton(bind));
            }
        }
    }
