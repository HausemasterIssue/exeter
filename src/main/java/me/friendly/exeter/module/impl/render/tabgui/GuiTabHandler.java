package me.friendly.exeter.module.impl.render.tabgui;
...
import me.friendly.exeter.module.impl.render.tabgui.item.GuiItem;
import me.friendly.exeter.module.impl.render.tabgui.item.GuiTab;
    ...
    public void drawGui(int x, int y) {
        ...
        for (int index = 0; index < this.tabs.size(); ++index) {
            ...
            if (Hud.customFont.getValue()){
                ...
                Minecraft.getMinecraft().fontRendererObj.drawString(tab.getLabel(), x + 2, yOff, -197380, true);
            }
