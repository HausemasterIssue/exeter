...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        ...
        {
            Exeter.getInstance().getEventManager().dispatch(new PlayerUpdateEvent());
    ...
    {
        MoveUpdateEvent event = new MoveUpdateEvent(posX, getEntityBoundingBox().minY, posZ, rotationYaw, rotationPitch, onGround);
        ...
        if (isCurrentViewEntity()) {
            ...
            if (isRiding()) {
                connection.sendPacket(new CPacketPlayer.PositionRotation(motionX, -999.0D, motionZ, yaw, pitch, grounded));
                moved = false;
        ...
        Exeter.getInstance().getEventManager().dispatch(new MoveUpdateEvent());
    }
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isHandActive() && !this.isRiding())
        {
            ...
            // no slow event
            Exeter.getInstance().getEventManager().dispatch(new SlowDownEvent(movementInput));
        }
